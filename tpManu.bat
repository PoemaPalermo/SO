...
:: Esto es para que aparezcan las tildes
chcp 65001
cls
...
echo.
echo 1.Borrar carpeta a eleccion.
echo 2.Agregar texto a eleccion dentro de editable.txt
echo 3.Hacer backup de Textos dentro de Otros
echo 4.Eliminar solo archivos basura dentro de Textos.
